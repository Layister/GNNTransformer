...
class LUNG(torch.utils.data.Dataset):
    ...
    """
    def __init__(self, train=True, gene_list=None, sr=False, fold=0):
    ...
    def get_img(self, name):
        img_fold = os.path.join('/Users/wuyang/Documents/MyPaper/2/GNNTransformer/data/Lung/', name,
    ...
    #     input_dir = os.path.join('/Users/wuyang/Documents/MyPaper/2/GNNTransformer/data/Lung/', name, 'outs/')
